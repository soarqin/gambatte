...
OBJS +=	gambatte_sdl_legacy/src/audiosink.o \
	gambatte_sdl_legacy/src/blitterwrapper.o \
	gambatte_sdl_legacy/src/parser.o \
	gambatte_sdl_legacy/src/sdlblitter.o \
	gambatte_sdl_legacy/src/str_to_sdlkey.o \
	gambatte_sdl_legacy/src/usec.o \
	gambatte_sdl_legacy/src/gambatte_sdl.o \
	gambatte_sdl_legacy/SFont.o \
	gambatte_sdl_legacy/menu.o \
	gambatte_sdl_legacy/libmenu.o \
	gambatte_sdl_legacy/scaler.o \
...
gambatte_sdl_legacy/menu.o: builddate

builddate:
	echo "#define BUILDDATE \"$$(date +'%Y%m%d-%H%M%S')"\" > ./gambatte_sdl_legacy/builddate.h
